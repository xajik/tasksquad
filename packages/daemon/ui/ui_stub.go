...
func Run(_ []AgentStatus, _ PullController, _ AuthController, _ AutostartController, _ ShutdownController, _ SkillsSyncer, _ ConveyorSyncer, _ string, _ string, _ string, _ int) {
	wl := acquireWakelock()
	defer wl.Release()
	select {}
}
