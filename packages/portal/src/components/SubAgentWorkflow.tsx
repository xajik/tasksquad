import { ArrowRight, User, Bot, FolderSync, FileCode, Zap, Play } from 'lucide-react'

export function SubAgentWorkflow() {
  const stages = [
    { icon: User, label: 'Create', color: 'bg-blue-500/10 text-blue-500' },
    { icon: Bot, label: 'Sub-agent', color: 'bg-purple-500/10 text-purple-500' },
